var trex,trex_running,ground,groundMoving,score,highScore,invisible_ground,trex_jump,cload,cloud_load,obstacle,ob1,ob2,ob3,ob4,ob5,ob6,obstacleGroup,cloudGroup,trex_collide,gameOver,GOimg,frameRandom,restart,restart_load,jumpSound,checkPoint,die,CP=100,rate=0.3;
const PLAY=1;
const END=0;
var gameState = PLAY;
